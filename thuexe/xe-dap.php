...
<?php require_once __DIR__. "/layouts/header.php"; ?>
    ...
    <div class="row content">
        <div class="col-md-9 trai" style="padding-left: 60px; padding-top:20px;padding-bottom: 50px;">
                ...
                <div class="col-md-3" style="margin-top: 50px;display:<?php echo $item['status'] == 0 ? 'none' : ''?>"">
                    <div class="card h-100" style="border-right: 2px solid red;margin-top: 50px;">
                        <a href="chi-tiet-xe.php?maxe=<?php echo $item['maxe']?>">
                            <img class="card-img-top" src="<?php echo base_url()?>public/uploads/xe/<?php echo $item['hinhanh'] ?>"
